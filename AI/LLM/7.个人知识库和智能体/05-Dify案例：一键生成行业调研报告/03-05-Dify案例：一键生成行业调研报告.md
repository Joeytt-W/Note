...
![image-20250304150734862](images/03-05-Dify案例：一键生成行业调研报告/image-20250304150734862.png)

#### ① 深度求索API

![image-20250304150902760](images/03-05-Dify案例：一键生成行业调研报告/image-20250304150902760.png)

![image-20250304151003895](images/03-05-Dify案例：一键生成行业调研报告/image-20250304151003895.png)

#### ② 兼容OpenAI API的供应商

如果待配置的模型供应商没有出现在官方提供的列表中，可以选择兼容OpenAI API的供应商，几乎所有供应商都兼容OpenAI API规范。

![image-20250304151226708](images/03-05-Dify案例：一键生成行业调研报告/image-20250304151226708.png)

**以腾讯云为例**

![image-20250304152606171](images/03-05-Dify案例：一键生成行业调研报告/image-20250304152606171.png)

![image-20250304152404903](images/03-05-Dify案例：一键生成行业调研报告/image-20250304152404903.png)

**模型名称**需要在腾讯云官方提供的API文档查询

![image-20250304152008367](images/03-05-Dify案例：一键生成行业调研报告/image-20250304152008367.png)
...
![image-20250312144431637](images/03-05-Dify案例：一键生成行业调研报告/image-20250312144431637.png)

这些插件需要在工具中搜索并安装：

![image-20250312144623393](images/03-05-Dify案例：一键生成行业调研报告/image-20250312144623393.png)

需要注意的是，电子邮件需要在精选中查找：

![image-20250312144648339](images/03-05-Dify案例：一键生成行业调研报告/image-20250312144648339.png)

#### ② google搜索授权

**注意：搜索工具需要授权，按照提示跳转至官网申请API Key即可。**

![image-20250311214913244](images/03-05-Dify案例：一键生成行业调研报告/image-20250311214913244.png)

![image-20250311214927084](images/03-05-Dify案例：一键生成行业调研报告/image-20250311214927084.png)

![image-20250311214949725](images/03-05-Dify案例：一键生成行业调研报告/image-20250311214949725.png)

![image-20250311215206193](images/03-05-Dify案例：一键生成行业调研报告/image-20250311215206193.png)

粘回来：

![image-20250311215238133](images/03-05-Dify案例：一键生成行业调研报告/image-20250311215238133.png)

#### ③ Firecrawl授权

授权过程：

![image-20250311220854998](images/03-05-Dify案例：一键生成行业调研报告/image-20250311220854998.png)

![image-20250311220911800](images/03-05-Dify案例：一键生成行业调研报告/image-20250311220911800.png)

![image-20250311221008112](images/03-05-Dify案例：一键生成行业调研报告/image-20250311221008112.png)

![image-20250311221035711](images/03-05-Dify案例：一键生成行业调研报告/image-20250311221035711.png)

#### ④ 电子邮件授权

需要授权，方式如下

![image-20250305145900652](images/03-05-Dify案例：一键生成行业调研报告/image-20250305145900652.png)
...
![image-20250311233652465](images/03-05-Dify案例：一键生成行业调研报告/image-20250311233652465.png)

![image-20250311233707070](images/03-05-Dify案例：一键生成行业调研报告/image-20250311233707070.png)

<img src="images/03-05-Dify案例：一键生成行业调研报告/image-20250813204523718.png" alt="image-20250813204523718" style="zoom:67%;" />

### 1.3 创建工作流

![image-20250304143212849](images/03-05-Dify案例：一键生成行业调研报告/image-20250304143212849.png)

![image-20250304143240677](images/03-05-Dify案例：一键生成行业调研报告/image-20250304143240677.png)
...
![image-20250304143441047](images/03-05-Dify案例：一键生成行业调研报告/image-20250304143441047.png)

![image-20250304143525956](images/03-05-Dify案例：一键生成行业调研报告/image-20250304143525956.png)
...
![image-20250304143712665](images/03-05-Dify案例：一键生成行业调研报告/image-20250304143712665.png)
...
![image-20250304143805581](images/03-05-Dify案例：一键生成行业调研报告/image-20250304143805581.png)

#### 2.2.2 配置输入

通过`/`或`{`唤起变量菜单，如下

![image-20250304144634931](images/03-05-Dify案例：一键生成行业调研报告/image-20250304144634931.png)

此处将target变量作为搜索工具节点的输入

![image-20250304144715072](images/03-05-Dify案例：一键生成行业调研报告/image-20250304144715072.png)

#### 2.2.3 配置输出

输出数据格式固定，如下

![image-20250304145420148](images/03-05-Dify案例：一键生成行业调研报告/image-20250304145420148.png)

#### 2.2.4 测试

![image-20250304150535536](images/03-05-Dify案例：一键生成行业调研报告/image-20250304150535536.png)

输入：

搜索框写入`中美两国AI发展现状`

![image-20250304174917652](images/03-05-Dify案例：一键生成行业调研报告/image-20250304174917652.png)

输出：

![image-20250304175005387](images/03-05-Dify案例：一键生成行业调研报告/image-20250304175005387.png)
...
![image-20250304145453391](images/03-05-Dify案例：一键生成行业调研报告/image-20250304145453391.png)

#### 2.3.2 配置输入

定义输入变量json，其值选择搜索节点输出中的json对象

![image-20250304145755193](images/03-05-Dify案例：一键生成行业调研报告/image-20250304145755193.png)

#### 2.3.3 编写代码

语言选择Python3，并写入代码，输出变量定义为result，类型为Array[Object]，如下

![image-20250304145855371](images/03-05-Dify案例：一键生成行业调研报告/image-20250304145855371.png)
...
![image-20250304175231735](images/03-05-Dify案例：一键生成行业调研报告/image-20250304175231735.png)
...
![image-20250304145951223](images/03-05-Dify案例：一键生成行业调研报告/image-20250304145951223.png)

#### 2.4.2 选择输入

![image-20250304150332344](images/03-05-Dify案例：一键生成行业调研报告/image-20250304150332344.png)
...
![image-20250304174635356](images/03-05-Dify案例：一键生成行业调研报告/image-20250304174635356.png)

![image-20250304174721618](images/03-05-Dify案例：一键生成行业调研报告/image-20250304174721618.png)

###### ③ 编写代码

![image-20250305111031472](images/03-05-Dify案例：一键生成行业调研报告/image-20250305111031472.png)
...
![image-20250304175507030](images/03-05-Dify案例：一键生成行业调研报告/image-20250304175507030.png)

**2. 测试结果如下**

![image-20250304175524572](images/03-05-Dify案例：一键生成行业调研报告/image-20250304175524572.png)
...
![image-20250304175839119](images/03-05-Dify案例：一键生成行业调研报告/image-20250304175839119.png)

###### ② 配置

![image-20250305100640293](images/03-05-Dify案例：一键生成行业调研报告/image-20250305100640293.png)
...
![image-20250305100824873](images/03-05-Dify案例：一键生成行业调研报告/image-20250305100824873.png)

###### ④ 测试

1. 输入

![image-20250305100919156](images/03-05-Dify案例：一键生成行业调研报告/image-20250305100919156.png)
...
![image-20250305101340468](images/03-05-Dify案例：一键生成行业调研报告/image-20250305101340468.png)
...
![image-20250305102402756](images/03-05-Dify案例：一键生成行业调研报告/image-20250305102402756.png)

###### ② 选择模型

![image-20250305102536699](images/03-05-Dify案例：一键生成行业调研报告/image-20250305102536699.png)
...
![image-20250813225602583](images/03-05-Dify案例：一键生成行业调研报告/image-20250813225602583.png)
...
![image-20250305104848545](images/03-05-Dify案例：一键生成行业调研报告/image-20250305104848545.png)
...
![image-20250305105347380](images/03-05-Dify案例：一键生成行业调研报告/image-20250305105347380.png)
...
![image-20250305105527381](images/03-05-Dify案例：一键生成行业调研报告/image-20250305105527381.png)
...
![image-20250305105733146](images/03-05-Dify案例：一键生成行业调研报告/image-20250305105733146.png)

#### 2.5.2 配置输入

![image-20250305105826996](images/03-05-Dify案例：一键生成行业调研报告/image-20250305105826996.png)

#### 2.5.3 编写代码

![image-20250305105927321](images/03-05-Dify案例：一键生成行业调研报告/image-20250305105927321.png)
...
![image-20250305110008713](images/03-05-Dify案例：一键生成行业调研报告/image-20250305110008713.png)
...
![image-20250305115231138](images/03-05-Dify案例：一键生成行业调研报告/image-20250305115231138.png)

##### 2. 输出

![image-20250305115246642](images/03-05-Dify案例：一键生成行业调研报告/image-20250305115246642.png)
...
![image-20250813231403075](images/03-05-Dify案例：一键生成行业调研报告/image-20250813231403075.png)
...
![image-20250305143200691](images/03-05-Dify案例：一键生成行业调研报告/image-20250305143200691.png)

##### 2. 输出

API请求超时，切换为内置模型测试。

![image-20250305143307432](images/03-05-Dify案例：一键生成行业调研报告/image-20250305143307432.png)
...
![image-20250305141107643](images/03-05-Dify案例：一键生成行业调研报告/image-20250305141107643.png)

#### 2.7.2 配置模型及输入变量

![image-20250305141242343](images/03-05-Dify案例：一键生成行业调研报告/image-20250305141242343.png)

> 这里也可以改为硅基流动的DeepSeek-V3模型试试。

#### 2.7.3 配置提取参数

![image-20250305141301788](images/03-05-Dify案例：一键生成行业调研报告/image-20250305141301788.png)

![image-20250305141336783](images/03-05-Dify案例：一键生成行业调研报告/image-20250305141336783.png)

#### 2.7.4 配置提示词

![image-20250305141426194](images/03-05-Dify案例：一键生成行业调研报告/image-20250305141426194.png)
...
![image-20250305141521813](images/03-05-Dify案例：一键生成行业调研报告/image-20250305141521813.png)

#### 2.7.6 测试

将LLM2节点输出的text字段作为输入

![image-20250305141621852](images/03-05-Dify案例：一键生成行业调研报告/image-20250305141621852.png)
...
![image-20250305141703083](images/03-05-Dify案例：一键生成行业调研报告/image-20250305141703083.png)
...
![image-20250305142217678](images/03-05-Dify案例：一键生成行业调研报告/image-20250305142217678.png)
...
![image-20250305142354309](images/03-05-Dify案例：一键生成行业调研报告/image-20250305142354309.png)

###### 2. 配置

![image-20250305143515520](images/03-05-Dify案例：一键生成行业调研报告/image-20250305143515520.png)
...
![image-20250305144432064](images/03-05-Dify案例：一键生成行业调研报告/image-20250305144432064.png)
...
![image-20250305145110390](images/03-05-Dify案例：一键生成行业调研报告/image-20250305145110390.png)
...
#### 2.9.1 创建
 ...
 <img src="images/03-05-Dify案例：一键生成行业调研报告/image-20250813234709489.png" alt="image-20250813234709489" style="zoom:67%;" />

#### 2.9.2 配置输入

 <img src="images/03-05-Dify案例：一键生成行业调研报告/image-20250813234752231.png" alt="image-20250813234752231" style="zoom:67%;" />
...
![image-20250305152406232](images/03-05-Dify案例：一键生成行业调研报告/image-20250305152406232.png)

#### 2.10.3 配置

![image-20250814000116555](images/03-05-Dify案例：一键生成行业调研报告/image-20250814000116555.png)

![image-20250305152509271](images/03-05-Dify案例：一键生成行业调研报告/image-20250305152509271.png)

#### 2.9.4 测试

![image-20250814000333926](images/03-05-Dify案例：一键生成行业调研报告/image-20250814000333926.png)
...
![image-20250814000533483](images/03-05-Dify案例：一键生成行业调研报告/image-20250814000533483.png)

**查看目标邮箱**

![image-20250814000619781](images/03-05-Dify案例：一键生成行业调研报告/image-20250814000619781.png)
...
![image-20250305153008125](images/03-05-Dify案例：一键生成行业调研报告/image-20250305153008125.png)

#### 2.10.2 配置

![image-20250305153143552](images/03-05-Dify案例：一键生成行业调研报告/image-20250305153143552.png)

### 2.11 试运行

#### 2.11.1 试运行

![image-20250305153224543](images/03-05-Dify案例：一键生成行业调研报告/image-20250305153224543.png)

#### 2.11.2 输入需求

![image-20250305153310702](images/03-05-Dify案例：一键生成行业调研报告/image-20250305153310702.png)
...
![image-20250305153638624](images/03-05-Dify案例：一键生成行业调研报告/image-20250305153638624.png)

可以追踪每个节点的运行情况

点开迭代节点可以查看每个子节点的运行情况

![image-20250305153725783](images/03-05-Dify案例：一键生成行业调研报告/image-20250305153725783.png)

![image-20250305154428200](images/03-05-Dify案例：一键生成行业调研报告/image-20250305154428200.png)

#### 2.11.4 查看运行历史

![image-20250305154323188](images/03-05-Dify案例：一键生成行业调研报告/image-20250305154323188.png)
...
![image-20250305155024254](images/03-05-Dify案例：一键生成行业调研报告/image-20250305155024254.png)

##### 2. 详情

![image-20250305155039878](images/03-05-Dify案例：一键生成行业调研报告/image-20250305155039878.png)
...
![image-20250812142553850](images/03-05-Dify案例：一键生成行业调研报告/image-20250812142553850.png)
