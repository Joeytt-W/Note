...
![image-20260607093627823](images/深度学习/image-20260607093627823.png)
...
![image-20260607095936973](images/深度学习/image-20260607095936973.png)

我们设计出了类似于神经元的神经网络，效果如下：

![image-20260607095945089](images/深度学习/image-20260607095945089.png)
...
![image-20260607095952078](images/深度学习/image-20260607095952078.png)
...
![image-20260607100001393](images/深度学习/image-20260607100001393.png)
...
![image-20260607100101166](images/深度学习/image-20260607100101166.png)

令 ${{z}^{\left( 2 \right)}}={{\theta }^{\left( 1 \right)}}x$，则 ${{a}^{\left( 2 \right)}}=g({{z}^{\left( 2 \right)}})$ ，计算后添加 $a_{0}^{\left( 2 \right)}=1$。 计算输出的值为：

![image-20260607100112970](images/深度学习/image-20260607100112970.png)
...
![image-20260607100148752](images/深度学习/image-20260607100148752.png)

右半部分其实就是以$a_0, a_1, a_2, a_3$, 按照**逻辑回归**的方式输出$h_\theta(x)$：

![image-20260607100200551](images/深度学习/image-20260607100200551.png)
...
![image-20260607100258816](images/深度学习/image-20260607100258816.png)
...
![image-20260607100310353](images/深度学习/image-20260607100310353.png)
...
![image-20260607100324352](images/深度学习/image-20260607100324352.png)
...
![image-20260607100447981](images/深度学习/image-20260607100447981.png)

下图的神经元（三个权重分别为-10，20，20）可以被视为作用等同于逻辑或（**OR**）：

![image-20260607100457578](images/深度学习/image-20260607100457578.png)

下图的神经元（两个权重分别为 10，-20）可以被视为作用等同于逻辑非（**NOT**）：

![image-20260607100511083](images/深度学习/image-20260607100511083.png)
...
![image-20260607100526341](images/深度学习/image-20260607100526341.png)

然后将表示 **AND** 的神经元和表示$\left( \text{NOT}\, \text{x}_1 \right) \text{AND} \left( \text{NOT}\, \text{x}_2 \right)$的神经元以及表示 OR 的神经元进行组合：

![image-20260607100536434](images/深度学习/image-20260607100536434.png)
...
![image-20260607100405972](images/深度学习/image-20260607100405972.png)

神经网络算法的输出结果为四种可能情形之一：

![image-20260607100415166](images/深度学习/image-20260607100415166.png)
...
![image-20260607100651599](images/深度学习/image-20260607100651599.png)
...
![image-20260607104149367](images/深度学习/image-20260607104149367.png)

具体来说，我们初始找到函数*f*(*x*1*,x*2)的一个点(*x*1*,x*2)，按下式进行更新：

![image-20260607104201469](images/深度学习/image-20260607104201469.png)

这样就可以沿着负梯度方向，找到一个新的点![image-20260607104243751](images/深度学习/image-20260607104243751.png)，让函数值更小。
...
![image-20260607100803387](images/深度学习/image-20260607100803387.png)
...
![image-20260607100817193](images/深度学习/image-20260607100817193.png)
...
![image-20260607100909621](images/深度学习/image-20260607100909621.png)

反向传播算法做的是：

![image-20260607100923159](images/深度学习/image-20260607100923159.png)
...
![image-20260607101013098](images/深度学习/image-20260607101013098.png)
...
![image-20260607101041610](images/深度学习/image-20260607101041610.png)
...
![image-20260607101057274](images/深度学习/image-20260607101057274.png)
